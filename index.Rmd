...
schedule <- data.frame(
  ...
  Topic = c("Welcome & Intro to choosing data visualizations", "ggplot color schemes", "leaflet", "making plot themes", "Mult-panel plots","swirl", "teaching R topic", "Spring Break", "Poisson regressions", "Interpreting model outputs", "for loops", "TBD", "intro to purr", "intro to target") 
